...
async def fast_track_extraction(target: dict, urls: List[str], scout_config: dict, first_rating: Any) -> tuple[List[Dict], List[Dict]]:
        ...
        for idx, url in enumerate(urls):
            ...
            try:
                ...
                if is_first and first_rating is not None:
                    stars = first_rating
                elif scout_config.get("reviews_api_url_template") and product_id:
                    ...
                    try:
                        ...
                        if api_resp.status_code == 200:
                            # Tâche extrêmement rapide par le LLM pour parser le JSON mystère
...
async def smart_scrape(target: dict):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            filename = f"data/scraped_{safe_name}_{cat}.json"
